...
class KMFButton : public KMFWidget
{
    ...
    public:
        ...
        void setUp(KMFButton *up)
        {
            m_buttons[Up] = up;
        };
        KMFButton*down() const
        {
            return m_buttons[Down];
        };
        void setDown(KMFButton *down)
        {
            m_buttons[Down] = down;
        };
        KMFButton*left() const
        {
            return m_buttons[Left];
        };
        void setLeft(KMFButton *left)
        {
            m_buttons[Left] = left;
        };
        KMFButton*right() const
        {
            return m_buttons[Right];
        };
        void setRight(KMFButton *right)
        {
            m_buttons[Right] = right;
        };
        const QString&direction(Direction dir) const
        {
        ...
        void setJump(const KMFJump &jump)
        {
            m_jump = jump;
        };
