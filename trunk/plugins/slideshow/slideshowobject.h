...
class Slide
{
    public:
        ...
        bool operator<(const Slide &t) const
        {
...
class SlideshowObject : public KMF::MediaObject
{
    ...
    public:
        ...
        const SlideList&slides() const
        {
            return m_slides;
        };
        void setSlides(const SlideList &slides)
        {
            m_slides = slides;
            m_thumbnail = QPixmap();
        };
        ...
        bool includeOriginals() const
        {
            return m_includeOriginals;
        };
        void setIncludeOriginals(bool includeOriginals)
        {
            m_includeOriginals = includeOriginals;
        };
        void setAudioFiles(const QStringList &audioFiles)
        {
        ...
        const QDVD::Subtitle&subtitleSettings() const
        {
            return m_subtitleSettings;
        }

        void setSubtitleSettings(const QDVD::Subtitle &s)
        {
            m_subtitleSettings = s;
        }
