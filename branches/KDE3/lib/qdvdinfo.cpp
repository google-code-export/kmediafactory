...
Cell::Cell(int cell, pgc_t *pgc) : m_cell(cell)
{
  int i;
  int strt = 0;
...
Subtitle::Subtitle(QString langCode, QString file) :
    ...
    m_align(Qt::AlignmentFlags(Qt::AlignAuto | Qt::AlignBottom))
{
...
Title::Title(int titleNbr, pgc_t* pgc, int pgcNbr, title_info_t* title,
             vtsi_mat_t* vtsi_mat)
  : m_titleNbr(titleNbr), m_pgc(pgcNbr)
{
