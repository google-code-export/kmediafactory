...
QStringList KMFDbusInterface::getOpenFileNames(const QString &startDir, const QString &filter,
...
void KMFDbusInterface::progressDialog(const QString &caption, const QString &label, int maximum)
{
...
int KMFDbusInterface::message(const QString &caption, const QString &txt, int type)
{
